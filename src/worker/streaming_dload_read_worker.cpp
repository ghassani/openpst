...
//  ^
// g++  -o streaming_dload hexdump.o endian.o sleep.o hdlc.o crc.o streaming_dload_window.o hdlc_serial.o streaming_dload_serial.o streaming_dload_read_worker.o streaming_dload.o moc_streaming_dload_window.o   -L/run/media/raab/Storage/Projects/cross-platform/openpst/openpst/build/qmake/ -lserial -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread
...
// /run/media/raab/Storage/Projects/cross-platform/openpst/openpst/build/qmake/../../src/worker/streaming_dload_read_worker.cpp:19: undefined reference to `vtable for openpst::StreamingDloadReadWorker'
...
// /run/media/raab/Storage/Projects/cross-platform/openpst/openpst/build/qmake/../../src/worker/streaming_dload_read_worker.cpp:24: undefined reference to `vtable for openpst::StreamingDloadReadWorker'
