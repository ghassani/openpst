...
PACKED(typedef struct QcdmNvAltRequest{
	uint8_t padding = 0x0;
	uint8_t data[DIAG_NV_ITEM_SIZE - 1] = {};
}) QcdmNvAltRequest;

PACKED(typedef struct QcdmNvAlt2Request{
	uint16_t padding = 0x0;
	uint8_t data[DIAG_NV_ITEM_SIZE - 2] = {};
}) QcdmNvAlt2Request;

PACKED(typedef struct QcdmNvRawRequest{
...
PACKED(typedef struct QcdmNvAltResponse{
	uint8_t cmd;
	uint16_t nvItem;
	uint8_t padding;
	uint8_t data[DIAG_NV_ITEM_SIZE - 1];
...
PACKED(typedef struct QcdmNvAlt2Response{
	uint8_t cmd;
	uint16_t nvItem;
	uint8_t padding[2];
	uint8_t data[DIAG_NV_ITEM_SIZE - 2];
